IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'Sesi_06_DB')
BEGIN
  CREATE DATABASE Sesi_06_DB;
END;
GO
...
INSERT INTO employees(first_name, last_name, email, phone_number, hire_date, job_id, salary, comission_pct, manager_id, department_id) VALUES
...
('Lex', 'DeHaan', 'LDEHAAN', '515.123.4569', '2001-01-13', 'AD_VP', 17000.00, 0.00, 100, 90),
...
('JoseManuel', 'Urman', 'JMURMAN', '515.124.4469', '2006-03-07', 'FI_ACCOUNT', 7800.00, 0.00, 108, 100),
