/*
*********************************************************************
Name: Modified from MySQL Sample Database classicmodels
Link: http://www.mysqltutorial.org/mysql-sample-database.aspx
Version 3.1
*********************************************************************
*/

IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'Customer_02_DB')
BEGIN
  CREATE DATABASE Customer_02_DB;
END;
GO
...
(172,'La Corne','Bertrand','Marie','(1) 42.34.2555','265, boulevard Charonne',NULL,'Paris',NULL,'75012','France',1337,'84300.00'),
...
(276,'Annas Decorations, Ltd','OHa','Anna','02 9936 8555','201 Miller Street','Level 15','North Sydney','NSW','2060','Australia',1611,'107800.00'),
...
(286,'Martaseplicas Co.','Hernandez','Marta','6175558555','39323 Spinnaker Dr.',NULL,'Cambridge','MA','51247','USA',1216,'123700.00'),
...
(496,'Kelly Gift Shop','Snowden','Tony','+64 9 5555500','Arenales 1938 3A',NULL,'Auckland  ',NULL,NULL,'New Zealand',1612,'110000.00');